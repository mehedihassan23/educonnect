      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-[95%] block">
          ...
          <div className="py-4">
            ...
            <span className="text-[15px] block text-end">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
          ...
          <div className="grid md:grid-cols-2 gap-5 mb-6">
            {currentQuiz?.options.map((option) => (
              <div key={option.label}>
                ...
                />
                <Label
                  className="border border-border rounded px-2 py-3 block cursor-pointer hover:bg-gray-300 transition-all font-normal"
