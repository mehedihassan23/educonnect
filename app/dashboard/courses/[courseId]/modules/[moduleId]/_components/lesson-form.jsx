...
import { createLesson, reOrderLesson } from "@/app/actions/lessons";
...
export const LessonForm = ({ initialData, moduleId, courseId }) => {
  ...
  return (
    <div className="relative mt-6 border bg-slate-100 rounded-md p-4">
      ...
      <LessonModal lesson={lessonToEdit} open={isEditing} setOpen={setIsEditing} courseId={courseId} moduleId={moduleId} onclose={() => {
