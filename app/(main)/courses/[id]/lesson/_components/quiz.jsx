       ...
       <div class="max-w-[270px] bg-white border border-border rounded-md dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
              ...
              <div class="p-4">
                ...
                >
                  ...
                  {isTaken ? <span> Quiz already participated</span> : <span>Participate in a Quiz</span>}
                </Button>
              </div>
       </div>

       <QuizModal courseId={courseId} quizSetId={quizSet._id.toString()}
       quizzes={quizzes} open={open} setOpen={setOpen} />
    </>
  )
}
